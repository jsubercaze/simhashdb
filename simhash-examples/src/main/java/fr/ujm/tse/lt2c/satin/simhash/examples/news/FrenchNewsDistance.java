...
public class FrenchNewsDistance {
	 ...
	 * List of databases
	 */
	private static final List<SimpleInMemoryHashDB> dbs = new ArrayList<>();
	...
	public static void main(final String[] args) throws Exception {
		...
		// }
		// // Prepare for stats
		// final Precision precision = new Precision(dbs.get(0).size(),
		// dbs.size());
		...
		// .println("------------------------------------------------------------------------------------");
		// int j = 0;
		// for (final SimpleInMemoryHashDB db : dbs) {
		// System.out.println();
		// System.out
		// .println("---------------------------------------------------");
		...
		// final int[] ids = db.kNNSorted(query, k);
		...
		// System.out.println("P@" + K + " for " + dbs.size() +
		// " databases with "
